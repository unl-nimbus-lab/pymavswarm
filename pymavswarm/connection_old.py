...
class Connection:
    ...
    def __send_mavlink_command(
        self,
        target_system: int,
        target_component: int,
        command_type: str,
        param_1: Union[float, int],
        param_2: Union[float, int],
        param_3: Union[float, int],
        param_4: Union[float, int],
        param_5: Union[float, int],
        param_6: Union[float, int],
        param_7: Union[float, int],
        confirmation: int = 0,
    ):
